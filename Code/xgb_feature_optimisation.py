...
def xgboost_training_run(feature_list):
    ...
    joblib.dump(feature_scaler, './xgboost_feature_selection/xgb_feature_scaler.joblib')
    ...
    if save == True:
        ...
        directory_name = f"./xgboost_feature_selection_2/{model_type}_{pressure_threshold}_{power_threshold}_{feature_names}"
...
empty_feature_list = ['Time of day', 'Time of year']
f1_reference = xgboost_training_run(empty_feature_list)
...
while True:
    ...
    for feature in candidate_features:
        ...
        f1 = xgboost_training_run(current_features)
